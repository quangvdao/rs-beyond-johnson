...
Copyright (c) 2026 Quang Dao, Scott Duke Kominers, Justin Thaler, and contributors.

## Code and certificate data

The authors' code under `scripts/`, the `Makefile`, and accompanying certificate
and regression data are available under either of the following licenses,
...
The licenses' own texts retain their respective terms.
